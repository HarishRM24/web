...
import logoPath from "@assets/image for footer_1751536034338.png";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div>
            ...
            <div className="space-y-3 text-neutral-400">
              ...
              <div className="flex items-start">
                ...
                <span>50 Cragwood Rd, Suite #222<br />South Plainfield, NJ – 07080</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-700 mt-12 pt-8 text-center">
          <p className="text-neutral-400">
            © 2025 NTimes.AI. All rights reserved. |{" "}
